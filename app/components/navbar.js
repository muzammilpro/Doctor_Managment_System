...
//                                 </Link>
//                                 <Link href="/contact">
//                                     <p className='hover:underline underline-offset-4'>Appointment</p>
//                                 </Link>
//                                 <Link href="/about">
...
//                                 </div>
//                                 <div className="">
//                                     <Link href="/cart"><Image src={img} width={20} height={20} /></Link>
//                                 </div>
//                             </div>
//                         </div>
//                     </div>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className={`lg:flex ${isOpen ? 'block' : 'hidden'}`}>
                        <div className="flex justify-between sm:gap-10">
                            ...
                            <div className="flex justify-between md:gap-3 ">
                                <div className="">
                                    {/* Uncomment the loginnSignup component */}
                                    
                                    <Link href="/login">
                                        <p className="hover:underline underline-offset-4">Login</p>
                                    </Link>
                                </div>
                                <div className="">
                                    <Link href="/cart">
