...
export default function Page() {
  return (
    <div>
      ...
      <div className="grid lg:grid-cols-3 gap-5 mb-16">
        <div className="rounded text-white text-center pt-5 text-2xl font-bold bg-green-600 h-40 shadow-sm">
          Total no of Doctors: <br /> 106
        </div>
        <div className="rounded text-white text-center pt-5 text-2xl font-bold bg-red-600 h-40 shadow-sm">
          Total number of Appointments: <br /> 164
        </div>
        <div className="rounded text-white text-center pt-5 text-2xl font-bold bg-blue-600 h-40 shadow-sm">
          Doctors Available: <br /> 74
        </div>
      </div>
